<div class="modal fade" id="tambahptrsihkebijakan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="judul">KEBIJAKAN PT RSIH BARU</h4>
            </div>
            <div class="modal-body">
                <form action="../controller/vptrsihkebijakan.php?unit=<?php echo($unit);?>" method="post" enctype="multipart/form-data">
