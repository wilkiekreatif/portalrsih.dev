<div class="modal fade" id="tambah_sdrs" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../controller/vsdrs.php?unit=<?php echo $unit;?>" method="post" enctype="multipart/form-data">
