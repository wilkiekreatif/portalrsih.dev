                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="../controller/updatenotulensi.php?id=<?php echo($w['id']); ?>" method="post">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <textarea required type="text" name="masalah" class="form-control" placeholder="..." rows="3" maxlength="50" disabled><?php echo($w['masalah']);
                                                    ?></textarea> 
                                            </div>
                                            <div class="form-group has-feedback">
