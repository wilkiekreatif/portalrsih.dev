        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><?php echo($_SESSION['menu'].'  '); ?><a href="#tambah_notulensi" class="btn btn-sm btn-success pull-right" id="NotID" data-toggle="modal"><i class="fa fa-upload"></i> TAMBAH NOTULENSI</a> </h1>
                        </div>
                                    ...
                                    <table width="100%" class="table table-bordered table-hover" id="dataTables-notulensi">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query="SELECT * FROM notulensi ORDER BY tgl_input ASC";
                                                //menjalankan query      
